...
export const AGENT_CONFIGS: AgentConfig[] = [
  { filename: "AGENTS.md", content: AGENTS_MD, description: "Codex / opencode" },
  { filename: "CLAUDE.md", content: CLAUDE_MD, description: "Claude Code" },
  { filename: ".cursorrules", content: CURSORRULES, description: "Cursor" },
  { filename: "GEMINI.md", content: GEMINI_MD, description: "Gemini" },
];